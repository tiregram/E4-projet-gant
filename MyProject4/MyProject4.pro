...
unrealRootPath=/home/ruhtra/Downloads/UnrealEngine-4.15.1-release
MyProject4RootPath=/home/ruhtra/Documents/Unreal Projects/MyProject4

gameProjectFile=/home/ruhtra/Documents/Unreal Projects/MyProject4/MyProject4.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(MyProject4Source.pri)
include(MyProject4Header.pri)
include(MyProject4Config.pri)
include(MyProject4Includes.pri)
include(MyProject4Defines.pri)
...
MyProject4-Linux-Debug.commands = $$build MyProject4 Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyProject4-Linux-DebugGame.commands = $$build MyProject4 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyProject4-Linux-Shipping.commands = $$build MyProject4 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyProject4-Linux-Test.commands = $$build MyProject4 Linux Test  -project="\"$$gameProjectFile\"" $$args
MyProject4.commands = $$build MyProject4 Linux Development  -project="\"$$gameProjectFile\"" $$args

MyProject4Editor-Linux-Debug.commands = $$build MyProject4Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyProject4Editor-Linux-DebugGame.commands = $$build MyProject4Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyProject4Editor-Linux-Shipping.commands = $$build MyProject4Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyProject4Editor-Linux-Test.commands = $$build MyProject4Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
MyProject4Editor.commands = $$build MyProject4Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	MyProject4-Linux-Debug \
	MyProject4-Linux-DebugGame \
	MyProject4-Linux-Shipping \
	MyProject4-Linux-Test \
	MyProject4 \
	MyProject4Editor-Linux-Debug \
	MyProject4Editor-Linux-DebugGame \
	MyProject4Editor-Linux-Shipping \
	MyProject4Editor-Linux-Test \
	MyProject4Editor \
