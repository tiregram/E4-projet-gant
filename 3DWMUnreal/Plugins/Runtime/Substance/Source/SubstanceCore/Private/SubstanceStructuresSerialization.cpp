...
FString LegacyChannelToString(int32 ChannelIndex)
{
	...
	{
	case CHAN_Diffuse:			return FString("diffuse");
	case CHAN_BaseColor:		return FString("baseColor");
	case CHAN_Metallic:			return FString("metallic");
	case CHAN_SpecularColor:	return FString("specularcolor");
	case CHAN_Specular:			return FString("specular");
	case CHAN_Roughness:		return FString("roughness");
	case CHAN_Emissive:			return FString("emissive");
	case CHAN_Normal:			return FString("normal");
	case CHAN_Displacement:		return FString("displacement");
	case CHAN_Mask:				return FString("mask");
	case CHAN_Opacity:			return FString("opacity");
	case CHAN_Refraction:		return FString("refraction");
	case CHAN_AmbientOcclusion:	return FString("ambientOcclusion");
...
FString GuiWidgetStringLabel(int32 Value)
{
	switch (Value)
	{
	case SubstanceAir::InputWidget::Input_Togglebutton: return "togglebutton";
	case SubstanceAir::InputWidget::Input_Color:		return "color";
	case SubstanceAir::InputWidget::Input_Slider:		return "slider";
	case SubstanceAir::InputWidget::Input_Combobox:		return "combobox";
	case SubstanceAir::InputWidget::Input_Image:		return "image";
	default: return "";
	};
