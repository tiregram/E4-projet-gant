...
unrealRootPath=/home/stephen/UnrealEngine
E4FIRootPath=/home/stephen/Documents/unrealProjects/E4-projet-gant/troisdhetWMUnreal

gameProjectFile=/home/stephen/Documents/unrealProjects/E4-projet-gant/troisdhetWMUnreal/E4FI.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(E4FISource.pri)
include(E4FIHeader.pri)
include(E4FIConfig.pri)
include(E4FIIncludes.pri)
include(E4FIDefines.pri)
...
E4FI-Linux-Debug.commands = $$build E4FI Linux Debug  -project="\"$$gameProjectFile\"" $$args
E4FI-Linux-DebugGame.commands = $$build E4FI Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
E4FI-Linux-Shipping.commands = $$build E4FI Linux Shipping  -project="\"$$gameProjectFile\"" $$args
E4FI-Linux-Test.commands = $$build E4FI Linux Test  -project="\"$$gameProjectFile\"" $$args
E4FI.commands = $$build E4FI Linux Development  -project="\"$$gameProjectFile\"" $$args

E4FIEditor-Linux-Debug.commands = $$build E4FIEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
E4FIEditor-Linux-DebugGame.commands = $$build E4FIEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
E4FIEditor-Linux-Shipping.commands = $$build E4FIEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
E4FIEditor-Linux-Test.commands = $$build E4FIEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
E4FIEditor.commands = $$build E4FIEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	E4FI-Linux-Debug \
	E4FI-Linux-DebugGame \
	E4FI-Linux-Shipping \
	E4FI-Linux-Test \
	E4FI \
	E4FIEditor-Linux-Debug \
	E4FIEditor-Linux-DebugGame \
	E4FIEditor-Linux-Shipping \
	E4FIEditor-Linux-Test \
	E4FIEditor \
